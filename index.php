...
<body>
  ...
  <div>
    <h2>Title: <?php echo $tron->title ?></h2>
    <p><strong>Description: </strong><?php echo $tron->description ?></p> <br>
    <?php if ($tron->producedBy):?>
      <span><strong>Produced by: </strong><?php echo $tron->producedBy ?></span> <br>
    <?php endif ?>
    <span><strong>Rating: </strong><?php echo $tron->rating ?></span>
  </div>

  <div>
    <h2>Title: <?php echo $avatar->title ?></h2>
    <p><strong>Description: </strong><?php echo $avatar->description ?></p> <br>
    <?php if ($avatar->producedBy):?>
      <span><strong>Produced by: </strong><?php echo $avatar->producedBy ?></span> <br>
    <?php endif ?>
    <span><strong>Rating: </strong><?php echo $avatar->rating ?></span>
  </div>

  <div>
    <h2>Title: <?php echo $matrix->title ?></h2>
    <p><strong>Description: </strong><?php echo $matrix->description ?></p> <br>
    <?php if ($matrix->producedBy):?>
      <span><strong>Produced by: </strong><?php echo $matrix->producedBy ?></span> <br>
    <?php endif ?>
    <span><strong>Rating: </strong><?php echo $matrix->rating ?></span>
  </div>
